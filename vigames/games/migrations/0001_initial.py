# Generated by Django 3.0.8 on 2020-08-05 13:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screenshots', models.ImageField(default=None, null=True, upload_to='img/%Y/%m')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.CharField(max_length=20, unique=True, verbose_name='Cсылка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='game', to='games.Game')),
            ],
        ),
        migrations.CreateModel(
            name='Posts',
            fields=[
                ...
                ('disliked', models.ManyToManyField(blank=True, related_name='disliked', to='games.Account')),
                ('image', models.ManyToManyField(blank=True, related_name='image', to='games.Media')),
                ('liked', models.ManyToManyField(blank=True, related_name='liked', to='games.Account')),
            ],
            options={
                'verbose_name': 'Запись',
        ...
        migrations.AddField(
            model_name='game',
            name='genre',
            field=models.ManyToManyField(blank=True, null=True, related_name='genre', to='games.Genre'),
        ),
        migrations.AddField(
            model_name='game',
            name='image',
            field=models.ManyToManyField(blank=True, related_name='game', to='games.Media'),
        ),
        migrations.AddField(
            model_name='game',
            name='players',
