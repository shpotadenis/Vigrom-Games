    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('players', models.ManyToManyField(null=True, related_name='players', to='games.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='games.Account')),
