                ...
                <div class="row ">
                    <div class="col-6">
                        ...
                        <div class="blocks">
                            ...
                            <textarea class="textInputs thirdInpits" v-model="short_description" placeholder="Не более 440 символов"/>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="blocks">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="blocks">
                            ...
                            <textarea class="textInputs thirdInpits" v-model="block1" placeholder="Не более 440 символов"/>
                        </div>
                        <div class="blocks">
                            <div class="blockName">Блок 3</div>
                            <textarea class="textInputs thirdInpits" v-model="block3" placeholder="Не более 440 символов"/>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="blocks">
                            <div class="blockName">Блок 2</div>
                            <textarea class="textInputs thirdInpits" v-model="block2" placeholder="Не более 440 символов"/>
                        </div>
